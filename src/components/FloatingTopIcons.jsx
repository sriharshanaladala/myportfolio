...
const FloatingTopIcons = ({ darkMode, setDarkMode }) => {
    ...
    return (
        <>
            ...
            <div className="float-icons">
                ...
                <a className="icon-link" href={githubUrl} target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                ...
                <a className="icon-link" href={linkedinUrl} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
...
export default FloatingTopIcons;
